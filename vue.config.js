  ...
  configureWebpack: {
    ...
    resolve: {
      alias: {
        ...
        // 'kokiri/dist': resolve('./external/kokiri/packages/kokiri/src'),
        // kokiri: resolve('./external/kokiri/packages/kokiri/src/index.ts'),
        // '@kokiri/element/dist': resolve('./external/kokiri/packages/element/src'),
        // '@kokiri/element': resolve('./external/kokiri/packages/element/src/index.ts'),
